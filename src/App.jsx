...
import Login from "./Login.jsx"; // וודא שיש לך את הקובץ
import Register from "./Register"; // וודא שיש לך את הקובץ
import Home from "./Home"; // הקובץ שיצרנו למעלה
  ...
  return (
    <div className="app-container">
      ...
      <nav style={{ padding: "1rem", borderBottom: "1px solid #ccc", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div className="logo">
          <Link to="/" style={{ fontSize: "1.5rem", fontWeight: "bold" }}>FitTrack</Link>
        </div>
